...
export default class ChartAlertas extends Component {
    ...
    render() {
        // this.props.data_array.push(this.props.data_array[this.props.data_array.length])
                ...
                <View style={{ width: 120 + Dimensions.get('window').width * 2, justifyContent: 'flex-end', backgroundColor: this.estilo.cor.white }}>
                    {this.props.data_array ?
                        <AreaChart
                            ...
                            data={(this.props.data_array).push(this.props.data_array[this.props.data_array.length])}
                    ...
                    {this.props.label_array ? <XAxis
                        ...
                        formatLabel={(index) => {
                            return this.props.label_array[index].split('T')[1].substring(0, 5) + 'h'
                        }}
                        contentInset={{ left: 10, right: 0 }}
